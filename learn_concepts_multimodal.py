...
def config():
    ...
    parser.add_argument("--out-dir", default="/home/cwh/Workspace/post-hoc-cbm-main/output/cifar100_output", type=str)
    parser.add_argument("--classes", default="cifar100", type=str)
...
if __name__ == "__main__":
    ...
    model, _ = clip.load(args.backbone_name.split(":")[1], device=args.device)
    print("finish!")
    concept_cache = {}
