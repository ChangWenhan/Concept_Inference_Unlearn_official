...
def get_model(args, backbone_name="resnet18_cub", full_model=False):
    if "clip" in backbone_name:
        ...
        backbone, preprocess = clip.load(clip_backbone_name, device=args.device)
        ...
        # model = torch.load("/home/cwh/Workspace/post-hoc-cbm-main/output/cub_output/resnet18_cub-2333-200d8b9c.pth")
