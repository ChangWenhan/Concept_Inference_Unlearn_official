...
from training_tools.embedding_tools import get_unlearn_projections


def config():
    parser = argparse.ArgumentParser()
    # parser.add_argument("--concept-bank", default="/home/cwh/Workspace/post-hoc-cbm-main/output/cifar100_output/multimodal_concept_clip:RN50_cifar100_recurse:1.pkl", type=str, help="Path to the concept bank")
    parser.add_argument("--concept-bank",
                        default="/home/cwh/Workspace/post-hoc-cbm-main/output/cifar10_output/multimodal_concept_clip:RN50_cifar10_recurse:1.pkl",
                        type=str, help="Path to the concept bank")
    parser.add_argument("--out-dir", default='/home/cwh/Workspace/post-hoc-cbm-main/output/cifar10_output', type=str, help="Output folder for model/run info.")
    parser.add_argument("--dataset", default="cifar10", type=str)
    parser.add_argument("--backbone_name", default="clip:RN50", type=str)  #resnet18_cub clip:RN50
...
def run_linear_probe(args, train_data, test_data, unlearn_data):
    train_features, train_labels = train_data
    test_features, test_labels = test_data
    unlearn_features, unlearn_labels = unlearn_data
...
if __name__ == "__main__":
    ...
    backbone.eval()
    main(args, concept_bank, backbone, transform)
