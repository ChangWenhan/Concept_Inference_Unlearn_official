...
def build_argparser():
    ...
    parser.add_argument("--mode", required=True, choices=["localized", "localized_gradcam", "localized_margin", "center", "random", "full"])
...
def make_variant(mode, clip_model, bank, target_img, donor_img, rng, size, target_concept, donor_concept,
                 classifier=None, pcbm=None, target_class=None):
    if mode == "localized":
